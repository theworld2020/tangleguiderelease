...
public class ContentMainBindingImpl extends ContentMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.upperunderline, 8);
        sViewsWithIds.put(R.id.playprotect, 9);
        sViewsWithIds.put(R.id.lowerunderline, 10);
        sViewsWithIds.put(R.id.ad_view_container, 11);
    }
    // views
    @NonNull
    ...
    private ContentMainBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (android.widget.TableRow) bindings[10]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.user == variableId) {
            ...
            setHandlers((openai.chatgpt.guide.view.MainActivity.MyClickHandlers) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setHandlers(@Nullable openai.chatgpt.guide.view.MainActivity.MyClickHandlers Handlers) {
    ...
    protected void executeBindings() {
        ...
        openai.chatgpt.guide.view.MainActivity.MyClickHandlers handlers = mHandlers;
        ...
        if ((dirtyFlags & 0x31L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView3, userAbout);
        }
        if ((dirtyFlags & 0x22L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x25L) != 0) {
            ...
            openai.chatgpt.guide.model.User.loadImage(this.profileImage, userProfileImage);
        }
    }
    // Listener Stub Implementations
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private openai.chatgpt.guide.view.MainActivity.MyClickHandlers value;
        public OnClickListenerImpl setValue(openai.chatgpt.guide.view.MainActivity.MyClickHandlers value) {
            this.value = value;
    ...
    public static class OnLongClickListenerImpl implements android.view.View.OnLongClickListener{
        private openai.chatgpt.guide.view.MainActivity.MyClickHandlers value;
        public OnLongClickListenerImpl setValue(openai.chatgpt.guide.view.MainActivity.MyClickHandlers value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
