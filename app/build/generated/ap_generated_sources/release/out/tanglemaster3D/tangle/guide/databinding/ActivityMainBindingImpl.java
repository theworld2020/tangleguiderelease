...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {1},
            new int[] {tanglemaster3D.tangle.guide.R.layout.content_main});
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeContent((tanglemaster3D.tangle.guide.databinding.ContentMainBinding) object, fieldId);
            case 1 :
                return onChangeUser((tanglemaster3D.tangle.guide.model.User) object, fieldId);
        }
        return false;
    }
    private boolean onChangeContent(tanglemaster3D.tangle.guide.databinding.ContentMainBinding Content, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
